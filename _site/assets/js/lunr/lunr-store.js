var store = [{
        "title": "2020-08-25 일기",
        "excerpt":"블로그 어제는 jekyll을 이용해서 테마도 정하고 깃헙 페이지로 배포까지 했다. 그래도 “개발자라면 깃허브로 블로그해야지!”라는 생각이 있었는데,, ㅎ,,, 너무 허접시려워서 민망하다.. 내가 제일 잘하는거. 일단 시작부터 하자. 나중에 예쁘게 고쳐도 돼. 일단 하자. 세부적인 설정은 다 김석진님 블로그 와 깃허브를 참고해서 만들었다. 진짜 여기 아니었으면 울 뻔 ,,흑흑 감사합니다. 사는동안 오래...","categories": ["Diary"],
        "tags": ["tdd","TIL"],
        "url": "http://localhost:4000/diary/post-Diary/",
